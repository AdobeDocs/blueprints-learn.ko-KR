---
title: Campaign v8, Campaign 및 플랫폼
description: Campaign v8의 아키텍처에 대해 알아봅니다.
...
>[!TIP]
>이 아키텍처는 Campaign Management &amp; Orchestration 아래에 [사용 사례 패턴](/help/blueprints/use-case-patterns/campaign-management-orchestration/campaign-v8-orchestration.md)으로도 설명되어 있습니다.
...
![FFDA(Campaign v8) 배포를 위한 참조 아키텍처](images/campaign-v8-ffda.png){width="1000" zoomable="yes"}

<br>

### Campaign v8 FDA 배포

![FDA(Campaign v8)용 참조 아키텍처](images/campaign-v8-fda.png){width="1000" zoomable="yes"}
...
이 아키텍처에는 다음과 같은 사전 요구 사항이 있습니다.
