...
| KPI | 설명 |
| --- | --- |
| 참여 | 채널 간 상호 작용 빈도, 깊이 및 폭에 대한 복합 측정 |
| 페이지에서 시간 | 방문자가 웹 콘텐츠에 참여하는 평균 시간 |
| 열람율 | 아웃바운드 통신과의 참여를 나타내는 이메일 및 메시지 열람율 |
...
| [여러 단계로 조정된 여정](/help/blueprints/use-case-patterns/campaign-management-orchestration/multi-step-orchestrated-journey.md) | 캠페인 관리 및 오케스트레이션 | 개인화된 콘텐츠와 타이밍을 통해 멀티터치 참여 여정을 통해 고객을 안내합니다. |
| [Brand Concierge 대화 경험](/help/blueprints/use-case-patterns/conversational-experience/brand-concierge-conversational-experience.md) | 대화 경험 | AI 기반의 대화 상호 작용을 통해 참여 심도 향상 |
