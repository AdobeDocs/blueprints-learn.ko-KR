...
+ 아키텍처 다이어그램{#architecture-diagrams}
  + [개요](/help/blueprints/architecture-diagrams/overview.md)
  + 아키텍처 개요{#architecture-overviews}
    + [개요](/help/blueprints/architecture-diagrams/architecture-overviews/overview.md)
    + [Adobe Experience Cloud](/help/blueprints/architecture-diagrams/architecture-overviews/experience-cloud.md)
    + [Adobe Experience Platform 및 애플리케이션](/help/blueprints/architecture-diagrams/architecture-overviews/platform-applications.md)
    + [Adobe Experience Platform 데이터 흐름](/help/blueprints/architecture-diagrams/architecture-overviews/platform-data-flow.md)
    + [Adobe Experience Platform 및 애플리케이션 보호](/help/blueprints/architecture-diagrams/architecture-overviews/guardrails.md)
  ...
  + 대상자 및 프로필 활성화{#audience-profile-activation}
    + [개요](/help/blueprints/architecture-diagrams/audience-profile-activation/overview.md)
    + [Adobe Real-Time CDP 활성화](/help/blueprints/architecture-diagrams/audience-profile-activation/rtcdp-activation.md)
    + [실시간 Edge 프로필 액세스](/help/blueprints/architecture-diagrams/audience-profile-activation/real-time-lookup.md)
    + [Adobe Real-Time CDP 및 Adobe Target 통합](/help/blueprints/architecture-diagrams/audience-profile-activation/rtcdp-target-integration.md)
  + B2B 활성화 및 마케팅{#b2b-activation-marketing}
    + [개요](/help/blueprints/architecture-diagrams/b2b-activation-marketing/overview.md)
    + [B2B 대상 및 프로필 활성화](/help/blueprints/architecture-diagrams/b2b-activation-marketing/b2b-audience-profile-activation.md)
    + [B2B 계정 활성화](/help/blueprints/architecture-diagrams/b2b-activation-marketing/b2b-account-activation.md)
  + 고객 인사이트{#customer-insights}
    + [개요](/help/blueprints/architecture-diagrams/customer-insights/overview.md)
    + [Adobe Customer Journey Analytics](/help/blueprints/architecture-diagrams/customer-insights/cja.md)
    + [Adobe Customer Journey Analytics 및 Adobe Journey Optimizer 통합](/help/blueprints/architecture-diagrams/customer-insights/cja-ajo-integration.md)
  + 고객 여정{#customer-journeys}
    + [개요](/help/blueprints/architecture-diagrams/customer-journeys/overview.md)
    + Journey Optimizer{#journey-optimizer}
      ...
      + [AJO 여정](/help/blueprints/architecture-diagrams/customer-journeys/journey-optimizer/journey-optimizer-journeys.md)
      + [AJO 캠페인](/help/blueprints/architecture-diagrams/customer-journeys/journey-optimizer/journey-optimizer-campaigns.md)
      + [서드파티 메시징](/help/blueprints/architecture-diagrams/customer-journeys/journey-optimizer/3rd-party-messaging.md)
    + Campaign v8{#campaign-v8}
      + [Campaign v8](/help/blueprints/architecture-diagrams/customer-journeys/campaign-v8/campaign-v8-overview.md)
      + [Adobe이 포함된 Real-Time CDP [!DNL Campaign] v8](/help/blueprints/architecture-diagrams/customer-journeys/campaign-v8/rtcdp-and-campaign-v8.md)
      + [Journey Optimizer와 Adobe Campaign v8](/help/blueprints/architecture-diagrams/customer-journeys/campaign-v8/ajo-and-campaign-v8.md)
