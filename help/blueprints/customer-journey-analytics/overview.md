...
Customer Journey Analytics 사용 사례 전체 목록은 여기에 있는 Customer Journey Analytics 설명서에서 확인할 수 있습니다.

## [Customer Journey Analytics 사용 사례 링크](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cja-usecases.html?lang=en)

기본 사용 사례 예는 다음과 같습니다.
| 블루프린트 | 설명 | 응용 프로그램 Experience Cloud | |—|—|—| | **[크로스 채널 여정 분석](Https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cross-channel.html?lang=ko)**  | <ul><li>다양한 웹, 모바일 및 오프라인 속성에서 수집한 데이터를 통합하여 전 채널에 걸친 고객 행동을 통합된 단일 관점으로 분석합니다.</li></ul> | <ul><li>Adobe Experience Platform</li><li>Customer Journey Analytics</li><li>Adobe Analytics(선택 사항)</li></ul>|
