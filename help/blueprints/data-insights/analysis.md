...
[!DNL Experience Platform]을(를) 통해 서드파티 SQL 클라이언트, 인터페이스 및 BI(Business Intelligence) 도구와의 연결을 통해 [!DNL Experience Platform] 프로토콜을 사용하여 [!DNL PostgreSQL] 내의 데이터에 직접 연결하고, 액세스하고, 쿼리할 수 있습니다.
