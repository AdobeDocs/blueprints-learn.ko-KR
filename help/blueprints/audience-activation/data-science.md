...
* [Adobe [!DNL Experience Platform] Intelligence 제품 설명](https://helpx.adobe.com/kr/legal/product-descriptions/adobe-experience-platform-intelligence---product-description.html)
* [Adobe [!DNL Experience Platform] 쿼리 서비스](https://experienceleague.adobe.com/docs/experience-platform/query/home.html?lang=ko)

## 관련 블로그 게시물

* [컨텐츠 및 Commerce AI: 컨텐츠 인텔리전스를 통해 고객과의 상호 작용 개인화](https://medium.com/adobetech/content-and-commerce-ai-personalizing-your-interactions-with-customers-through-content-intelligence-dc182601deab)
* [Adobe [!DNL Experience Platform]의 탐색적 데이터 분석에 대한 소개 보기](https://medium.com/adobetech/an-introductory-look-at-exploratory-data-analysis-on-adobe-experience-platform-1bfce7501d9a)
* [머신 러닝을 통해 사용자 경험을 향상시킨 Adobe 경험 제품](https://medium.com/adobetech/cutting-across-adobe-experience-products-with-machine-learning-to-elevated-user-experience-7c85000510d1)
* [Segmentation.AI: Adobe [!DNL Experience Platform]의 Automated Audience-Clustering-as-a-Service](https://medium.com/adobetech/segmentation-ai-automated-audience-clustering-as-a-service-in-adobe-experience-platform-261f4099462c)