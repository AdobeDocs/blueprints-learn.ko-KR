...
1. [Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-segments.html?lang=ko) 에서 세그먼트 만들기 자동으로 세그먼트가 일괄 처리 또는 스트리밍으로 평가되는지 확인합니다.
