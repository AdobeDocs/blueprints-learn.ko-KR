...
description: 오케스트레이션된 캠페인의 셸을 만들고 기본 예약 옵션을 검토하는 방법을 알아봅니다.
doc-type: article
...
![앱 서랍에서 Adobe Journey Optimizer 선택](assets/create-an-orchestrated-campaign-select-ajo-app.png)
...
![캠페인 워크플로에서 &quot;예약 옵션&quot;을 실행하는 빈도에 대한 예약 옵션](assets/create-an-orchestrated-campaign-scheduler-options.png "예약 옵션")
