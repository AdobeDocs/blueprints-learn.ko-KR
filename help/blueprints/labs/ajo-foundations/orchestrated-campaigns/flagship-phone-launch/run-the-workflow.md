...
다음 몇 단계에서는 테스트 모드를 사용하여 워크플로우와 더 중요하게는 SMS 활동을 테스트하는 방법을 배웁니다.
...
- 실시간 고객 프로필에 가입하려면 고객 ID가 있어야 하며 해당 4개 레코드에 없으므로 프로필을 조회하거나 즉시 새 프로필을 만들 방법이 없습니다
...
>[!TIP]
>
>축하합니다! 이제 여러분은 자신의 오케스트레이션된 캠페인을 펼치고 전 세계에 메시지를 책임감 있게 방송할 수 있는 것으로 공식적으로 인증되었습니다. 장엄한 디지털 마법사처럼 시장에 나아가십시오!
...
1. 대상자 저장 활동은 Audience Portal에서 대상자 셸을 만들고 자격이 있는 프로필은 수집을 시작합니다
