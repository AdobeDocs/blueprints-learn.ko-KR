...
1. **작업 탭**&#x200B;을 클릭하고 **내** 전자 메일 구성을 선택합니다. 샌드박스에서 이를 관계형 이메일로 표시할 수 있습니다. (임의 선택)
