...
<img src="images/rtcdp-campaign-v8-architecture.svg" alt="배치 메시징과 Adobe Experience Platform 통합 패턴의 참조 아키텍처" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />
