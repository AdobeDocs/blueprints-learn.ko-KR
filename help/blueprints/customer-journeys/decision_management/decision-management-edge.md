...
허브의 의사 결정 관리에 대한 자세한 내용은 [허브의 의사 결정 관리](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/offer-decisioning/decision-management-hub.html) 블루프린트를 참조하세요.
...
<img src="../assets/offers_edge.svg" alt="Edge 블루프린트에서 참조 아키텍처 결정 관리" style="width:100%; border:1px solid #4a4a4a" />
...
| 통합 | 설명 |
| :-- | :--- |
| [Adobe Target을 사용한 의사 결정 관리](https://experienceleague.adobe.com/docs/target/using/integrate/ajo/offer-decision.html?lang=ko) | 의사 결정 관리 를 Adobe Target과 통합하여 오퍼를 Target 경험으로 테스트 및 전달할 수 있습니다. |
...
* 웹 사이트 및 모바일 애플리케이션에서 배포를 위해 Web 또는 Mobile SDK를 사용하여 SDK가 배포된 의사 결정 관리를 구현합니다.
...
* API 서버간 서버 기반 구현의 경우 서버 간 의사 결정 관리 구현을 위해 Edge Network Service API를 사용하십시오.
