...
이 패턴은 범위가 알려진 방문자 웹/앱 개인화와는 다릅니다. offer decisioning은 채널과 관계없고 중앙 집중화된 반면, 알려진 방문자 개인화는 디지털 표면 개인화에 중점을 둡니다. 이 방법은 행동 추천과 다릅니다. offer decisioning은 명시적 자격 규칙과 등급 전략을 사용하는 반면, 행동 추천은 선택 전략 및 ML 모델을 사용하여 행동 신호 기반 추천을 강조합니다.
...
- [코드 기반 경험 채널](https://experienceleague.adobe.com/ko/docs/journey-optimizer/using/channels/code-based-experience/get-started-code-based)
