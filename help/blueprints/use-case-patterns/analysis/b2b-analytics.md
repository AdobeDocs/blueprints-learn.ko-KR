...
| 대상자 게시 | 4단계: 대시보드 게시 | 다운스트림 활성화를 위해 [!DNL CJA]에서 정의한 계정 기반 대상 게시 |
...
- [ ] [!DNL CJA] B2B edition 라이선스가 활성화되어 조직에 대해 프로비저닝되었습니다.
- [ ] [!DNL RT-CDP] B2B edition 라이선스가 B2B 스키마 및 계정 프로필이 구성된 상태로 활성 상태입니다.
- [ ]개의 B2B XDM 스키마가 정의되어 있습니다(계정, 영업 기회, 계정 사용자 관계, 영업 기회 사용자 관계, 마케팅 목록 구성원).
- [ ] [!DNL Marketo Engage] 및/또는 CRM 원본 커넥터가 구성되어 있고 데이터를 활성 상태로 수집하고 있습니다.
- [ ] 계정 수준 동작 이벤트 데이터(웹 방문, 전자 메일 상호 작용, 양식 제출)가 계정 연결이 있는 AEP으로 흘러가고 있습니다.
- [ id 그래프에 ] 개인-계정 관계가 설정되어 있습니다.
- [ ] 최소 30일 동안의 이전 B2B 참여 데이터를 의미 있는 분석에 사용할 수 있습니다.
- [ ] 이해 당사자가 그룹 역할 정의 및 솔루션 관심 분야 매핑을 구입하는 데 동의했습니다.
- [ ] [!DNL CJA] 사용자 계정이 B2B edition 기능에 적합한 제품 프로필로 프로비저닝되었습니다.
- [ ]개의 대상 KPI 및 보고 요구 사항이 마케팅 및 영업 리더쉽에 의해 정의되었습니다.
