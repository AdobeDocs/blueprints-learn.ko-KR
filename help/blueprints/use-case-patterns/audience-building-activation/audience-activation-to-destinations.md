...
![Enterprise 대상에 대한 대상 및 프로필 활성화를 위한 참조 아키텍처](/help/blueprints/audience-activation/assets/known_activation.svg)
...
| 대상 정의 및 세분화 | 필수 | 세그먼트 빌더, 대상 구성 또는 연결된 대상 구성을 사용하여 정의된 Target 대상입니다. 활성화 지연 요구 사항에 따라 선택한 평가 방법(일괄 처리, 스트리밍 또는 에지)입니다. 이 기능은 이 플랜의 1단계에서 수행됩니다. | [세그먼테이션 서비스 개요](https://experienceleague.adobe.com/en/docs/experience-platform/segmentation/home), [세그먼트 빌더 UI 안내서](https://experienceleague.adobe.com/en/docs/experience-platform/segmentation/ui/segment-builder) |
...
**응용 프로그램 기능:** RT-CDP: 대상 평가, RT-CDP: 대상 구성
...
**응용 프로그램 기능:** RT-CDP: Audience Activation
...
**응용 프로그램 기능:** RT-CDP: 동의 및 거버넌스 적용
