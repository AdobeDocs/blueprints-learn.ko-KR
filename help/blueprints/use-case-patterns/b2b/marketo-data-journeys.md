...
* **AJO B2B에 대한 기본 매핑 사용:**
  * 구매 그룹 논리 및 여정 오케스트레이션과의 호환성을 보장하려면 Journey Optimizer B2B Edition용 [표준 필드 매핑](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/admin/xdm-field-management/field-mapping)을 채택하십시오.
...
Adobe Journey Optimizer B2B Edition 구현 시 실시간 고객 데이터 플랫폼에서 제공하는 ID 결합 기능을 이해하는 것이 중요합니다. 이 플랫폼은 개인 및 계정 수준 모두에서 ID 결합을 수행하여 고객 데이터를 통합적으로 볼 수 있도록 합니다.
