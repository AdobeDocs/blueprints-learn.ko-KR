---
title: 통신 산업 - 트리거된 메시징을 위한 Journey Optimizer
...
이 블루프린트를 구현하기 전에 통신 회사의 &quot;새 회선 추가&quot; 이메일 캠페인은 사용자가 전환했는지 여부에 따라 결정되었으며 7일의 대기 기간 후에만 이를 확인했습니다. 이 기준이 충족되야만 접점이 추가되었습니다.
...
## 기본 블루프린트: Experience Cloud 애플리케이션으로 대상자 및 활성화
