...
>[!NOTE]
>
>현재 Journey Optimizer B2B edition에서 지원하는 유일한 관계는 `Person` 엔터티의 `personComponents[0].sourceAccountKey.sourceKey` 특성을 통한 직접적인 관계입니다. 향후 확장은 B2b 스키마의 계정-사용자 관계 개체를 수용하도록 계획되어 있습니다.
