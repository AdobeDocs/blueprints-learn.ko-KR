...
![Campaign 실행 계획 - 자동화 사용 사례](assets/overview-1.png){zoomable="yes"}

캠페인 개발 프로세스의 여러 단계에 주목하세요.

1. 가져오기 및 만들기: 캠페인에 대한 요청을 만들고 프로그래밍 방식으로 캠페인 자산을 모읍니다.

1. 검토 및 승인: 캠페인을 조직한 후 이해 당사자가 이메일, 랜딩 페이지 등 캠페인 자산을 검토 및 승인합니다.
...
![Workfront에서 마케팅 이니셔티브를 표시하는 방법 이해](assets/overview-2.png){zoomable="yes"}

### 포트폴리오 계층의 정의 {#portfolio-hierarchy-defined}
...
<table> 
  ...
  <tr> 
   <td>포트폴리오</td>
   <td>Workfront의 [포트폴리오] 및 [프로그램]을 사용하여 [프로젝트]를 구성할 수 있습니다. 프로젝트 구성을 통해 유사한 프로젝트를 비교하고 리소스가 가장 많이 사용될 위치를 결정할 수 있습니다.<br /><br />
   (예: Portfolio은 서비스 및/또는 제품 판매에 중점을 두는 회사 내 사업부를 위해 만들어집니다.)</td>
  </tr>
  <tr>
   <td>프로그램</td>
   <td>Workfront의 [프로그램]을 사용하여 [프로젝트]를 구성할 수 있습니다. 프로젝트 구성을 통해 유사한 프로젝트를 비교하고 리소스가 가장 많이 사용될 위치를 결정할 수 있습니다.<br /><br />
   (예: 인지도를 높이고 새 제품 출시에 대한 수요를 유도하는 등 높은 수준의 목표를 가진 마케팅 전략)</td>
  </tr>
  <tr>
   <td>프로젝트</td>
   <td>Workfront 프로젝트는 특정 목표, 결과물, 제품 등을 달성하기 위해 완료해야 하는 작업 항목의 컬렉션입니다.<br /><br />
   (예: 이메일 돌풍, 육성 캠페인, 웨비나 또는 직접 이벤트와 같은 마케팅 전술) 단일 [프로젝트]에 이메일, 디스플레이 광고, 랜딩 페이지, 다운로드 가능한 백서 등 동일한 성과를 창출하기 위한 여러 전술을 포괄하여 보다 복잡하게 만들 수도 있습니다.)</td>
  </tr>
  <tr>
   <td>작업</td>
   <td>Workfront의 [작업]은 계획된 작업 항목으로, [프로젝트]나 이니셔티브의 일부일 수 있습니다. 작업을 완료할 사용자 또는 팀에 할당되었습니다.<br /><br />
   (예: 대상 세그먼트를 작성하거나 이메일 초안을 만드는 작업은 Marketo Engage 이메일 프로그램을 개발하는 프로젝트와 연결된 작업일 수 있습니다.)</td>
  </tr>
  <tr>
   <td>문제</td>
   <td>문제는 Workfront의 계획되지 않은 작업 항목입니다. 프로젝트 중에 발생하는 문제이거나 요청 대기열을 통해 제출된 요청일 수 있습니다.<br /><br />
   (예: 이메일 배너 이미지의 크기가 잘못되어 문제가 발생합니다.)</td>
  </tr>
  <tr>
   <td>문서</td>
   <td>문서는 워드 문서나 프레젠테이션 등 기존 방식의 문서일 수 있습니다. 이미지 파일일 수도 있습니다. Workfront을 사용하면 문서 및 이미지에 대한 댓글 및 주석을 통해 에셋을 교정할 수 있으므로 팀 간의 공동 작업이 가능합니다.<br /><br />
   (예: 검토해야 하는 이메일 헤더 이미지)</td>
  </tr>
  <tr>
   <td>업데이트</td>
   <td>Workfront에서 작업을 추적하고 공동 작업을 용이하게 하기 위한 댓글과 감사 로그를 포함합니다.<br /><br />
...
![마케팅 이니셔티브 작업 관리 예](assets/overview-3.png){zoomable="yes"}
...
![Marketo Engage 프로그램에 Workfront 프로젝트 매핑](assets/overview-4.png){zoomable="yes"}
...
### Workfront 작업을 Marketo Engage 자산에 매핑하기 {#mapping-workfront-tasks-to-marketo-engage-assets}
...
캠페인 및 URL의 이름 지정 규칙을 표준화하면 Marketo Engage에서 프로그램을 정확하게 관리하고 캠페인 개발 수명 주기 전반에서 더욱 일관된 프로세스를 구현하는 데 도움이 됩니다. 이 작업에 도움이 되는 도구를 찾고 있다면 Adobe 캠페인 및 관련 URL을 만들고 관리하는 일관된 방법을 만들 수 있도록 [Marketo Engage 성공 서비스](https://main--marketo-campaign-tools--dr-adobe.hlx.live/){target="_blank"}에서 무료 오픈 소스 도구를 체크 아웃하는 것이 좋습니다.
