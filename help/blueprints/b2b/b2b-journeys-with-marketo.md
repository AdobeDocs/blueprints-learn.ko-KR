...
* 모든 계정 여정에서 최대 5백만 계정
* 모든 계정 여정에서 최대 4,000만 명
* 구매 그룹 및 여정에서 계정당 최대 1,000명
* [프로필 및 세분화 가드레일](https://experienceleague.adobe.com/en/docs/experience-platform/profile/guardrails)
