...
| 유형 | 목적 | 위치 / 예 |
|------|---------|--------------------|
| **개요/허브** | 제품 또는 영역 소개, 시나리오 블루프린트 링크 | e.g. `overview.md`, `journey-optimizer-overview.md` |
...
| **구현 고려 사항** | 중요한 주의 사항이 있을 때 | 하위 섹션(예: ID 고려 사항, 속성 기반 개인화). 글머리 기호 또는 짧은 문단입니다. 링크를 통해 깊이 있게 연결할 수 있습니다. |
